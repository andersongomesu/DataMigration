				...
				<div class="form-group">
					...
					<div class="col-xs-6 col-sm-4">
						<h4>
							...
							<img style='display: block; width: 100px; height: 100px;'
								id='productLine1'
								src='data:image/jpeg;base64,<c:out value='${productLineImageAsString}'/>'
								alt="product line image" />
<%-- 							<img style='display: block; width: 100px; height: 100px;'
								id='productLine1'
								src='data:image/jpeg;base64,<c:out value='${productLineImage}'/>'
								alt="product line image as byte" />		 --%>						
							<!-- <img src="image" alt="product line image" /> -->
						</h4>
					</div>
				</div>
			</div>
