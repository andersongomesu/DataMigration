...
public class MysqlToMongoOnlineLoadTest {
	...
	public void loadDataFromMysqlToMongoIncludingChildTablesTest() {
		...
		Boolean loadStatus = mysqlToMongoOnlineLoad.loadDataFromMysqlToMongo(
				IApplicationConstants.defaultMySqlSchemaName, "customers", "test", "mycol111", 10L, true);
	...
	public void loadDataFromMysqlToMongoWithoutChildTablesTest() {
		...
		Boolean loadStatus = mysqlToMongoOnlineLoad.loadDataFromMysqlToMongo(
				IApplicationConstants.defaultMySqlSchemaName, "customers", "test", "mycol111", 10L, false);
